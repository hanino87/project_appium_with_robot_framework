...
Validate Login With Invalid Password And Get Right Error Message
...
Validate Login With Invalid Username And Get Right Error Message 
...
Validate Login With Lockedout Customer And Get Right Error Message 
...
Validate Login With Normal User 
  Set Env Vars For Password In Swaglabs
  Set Env Vars For Username 1 In Swaglabs
  When I Am On SwagLabs Login Page
...
Validate Login With No Username And Get Right Error Message 
  Set Env Vars For Password In Swaglabs
  When I Am On SwagLabs Login Page
...
Validate Login With No Password And Get Right Error Message 
  Set Env Vars For Username 1 In Swaglabs
  When I Am On SwagLabs Login Page
